      ...
      case "ADD_TO_LIKED_USERS":
        if (!people[activeUser].likedUsers.includes(userId)) {
          ...
          const response = async () => {
            await axios.post("http://localhost:5000/api/users/like", {
              id: userId,
              currentUserId: localStorage.id
            });
          };
    ...
    <div className='container'>
                ...
                <fieldset className="fieldset-style">
                  <label>
                    ...
                    >
                      ...
                      <option value="Бельгийская овчарка малинуа">
                        Бельгийская овчарка малинуа
                      </option>
                      <option value="Бельгийский гриффон">
                        Бельгийский гриффон
                      </option>
                      ...
                      <option value="Венгерская короткошерстная легавая(выжла)">
                      ...
                      <option value="Дратхаар">Дратхаар</option>
                      <option value="Другая">Другая</option>
                      <option value="Западносибирская лайка">
                        Западносибирская лайка
                      </option>
                      <option value="Золотистый ретривер">
                        Золотистый ретривер
                      </option>
                      ...
                      <option value="Кане корсо">Кане корсо</option>
                      <option value="Кеесхонд">Кеесхонд</option>
                      <option value="Китайская хохлатая">
                        Китайская хохлатая
                      </option>
                      <option value="Колли">Колли</option>
                      <option value="Комондор">Комондор</option>
                      ...
                      <option value="Русская гончая">Русская гончая</option>
                      <option value="Русский спаниель">Русский спаниель</option>
                      <option value="Русско-европейская лайка">
                        Русско-европейская лайка
                      </option>
                      <option value="Самоедская лайка">Самоедская лайка</option>
                      <option value="Сенбернар">Сенбернар</option>
                      <option value="Среднеазиатская овчарка">
                      ...
                      <option value="Той-терьер">Той-терьер</option>
                      <option value="Фокстерьер">Фокстерьер</option>
                      <option value="Французский бульдог">
                        Французский бульдог
                      </option>
                      <option value="Хаски">Хаски</option>
                      <option value="Цвергшнауцер">Цвергшнауцер</option>
                      ...
                      <option value="Эрдельтерьер">Эрдельтерьер</option>
                      <option value="Эстонская гончая">Эстонская гончая</option>
                      <option value="Южноафриканский бурбуль">
      ...
      <div className="app" id="app-1">
        ...
        {people &&
          people.map(elem => {
            return (
              <div className="sliderSpecial">
                <div className="sliderSpecial-1">
                  <div className="sliderSpecial-box">
                    <Person
                      key={elem.id}
                      person={elem}
                      modifySuperficialChoices={modifySuperficialChoices}
